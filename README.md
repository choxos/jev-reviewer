...
full; on a phone that list stands for the tabs once there are two files, with a × for the open one. Links in a PDF work as in a PDF reader: a web address opens in a new tab (an address only
